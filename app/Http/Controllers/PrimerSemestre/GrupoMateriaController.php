...
use App\Exports\ProgramasMateriasExport;
...
class GrupoMateriaController extends Controller
{
    ...
    //Exportar Materias y programas
    public function export()
    {
      //return Excel::download(new UsersExport, 'Materias.xlsx');
      return Excel::download(new ProgramasMateriasExport, 'Materias.xlsx');
    }
